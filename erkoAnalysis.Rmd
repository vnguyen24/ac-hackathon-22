...
```{r attendance at each game 18-19}
...
```{r attendance at each game 21-22}
...
```{r attendance at tip each game based on promo 18-19}
...
```{r attendance at tip at each game based on promo type 18-19, echo=FALSE}
ggplot(data = tip_timeline_18_19, 
       aes(x = Game.Date, y = Attendance.at.tip, color = type_promo)) + 
  geom_point() + 
  geom_line() +
  # Add labels
  labs(title = "Attendance at Tip Depending on Promo Type 2018-19",
       x = "Game Date", 
       y = "Attendance at tip", 
       color = "Promo type")
```
...
ggplot(data = tip_timeline_21_22, 
  ...
  geom_line() +
  # Add labels
  labs(title = "Attendance at Tip Depending on Promo Type 2021-22",
       x = "Game Date", 
       y = "Attendance at tip", 
       color = "Promo type")
```